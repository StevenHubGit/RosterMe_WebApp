...
namespace RosterMe.Controllers.EntitiesControllers
{
    public class EmployeesController : Controller
    {
        ...
        public JsonResult EmployeesList()
        {
            ...
            {
                x.EmployeeId, x.FirstName, x.LastName//, x.Gender, x.DOB, x.Email,
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,FirstName,LastName,Gender,ProfilePicture,DOB,JoiningDate,Position,UserRole,PhoneNumber,Email,Contract,ReportingManagerId,DepartmentId,HourlySalary")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,FirstName,LastName,Gender,ProfilePicture,DOB,JoiningDate,Position,UserRole,PhoneNumber,Email,Contract,ReportingManagerId,DepartmentId,HourlySalary")] Employee employee)
        {
