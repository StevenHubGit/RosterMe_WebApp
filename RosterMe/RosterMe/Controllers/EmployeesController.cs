...
namespace RosterMe.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,FirstName,LastName,Gender,ProfilePicture,DOB,JoiningDate,Position,PhoneNumber,Email,Contract,ReportingManagerId,DepartmentId,HourlySalary")] Employee employee)
        {
